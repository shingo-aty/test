...
contract Test64 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x80c489097a65AC817eEe6De9ED441456CED65B21); // Marketing Address
        
    address payable public buybackAddress =
        payable(0x80c489097a65AC817eEe6De9ED441456CED65B21); // BuyBack Address
    ...
    string private constant _name = "Test64";
    string private constant _symbol = "Test64";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x80c489097a65AC817eEe6De9ED441456CED65B21).call{value: bnbForDev}("");
